  ...
  const historicalPeriods = [
    {
      ...
      description: "ADIGBE Togbédji, originaire du petit village de Mondotokpa à Dangbo, reçut une mission transcendante pour créer le script d'incarnation des langues africaines. En 1983, il adressa un message prophétique aux gouvernants sur la sécheresse financière qui guetterait le pays. Cette prophétie lui valut une incarcération de six années sans procès ni jugement. Paradoxalement, la crise annoncée frappa effectivement le Bénin en 1983.",
      detailedStory: "Au cours de sa sixième année d’emprisonnement, il réitéra le même message aux mêmes gouvernants qui, cette fois, décidèrent de l’amnistier et de le libérer. Après sa libération en fin d’année 1989, ADIGBE Togbédji entreprit une quête spirituelle et scientifique extraordinaire. Pour découvrir la “maquette de développement” qu’était le script d’incarnation, l’homme s’imposa des conditions de vie extrêmes : il resta sans manger ni boire pendant plusieurs semaines. Quand il s’alimenta, ce fut comme les hommes de l’époque primitive : une boule d’akassa accompagnée d’huile rouge sans sel ni piment. Il parcourut toutes ses distances à pied, quelles qu’elles fussent.",
    ...
    },
    {
      ...
      description: 'En 1995, après douze années de recherche, ADIGBE Togbédji fit une annonce historique : “ça y est, ce que tout le monde attendait de mes œuvres est là : le Script des peuples pour l’autonomie de chaque nation fut conçu. Il eut 33 lettres dont 24 consonnes et 9 voyelles.” Le système Gbekoun naquit, conçu comme un script à la fois syllabique et phonétique, doté de chiffres décimaux, de ponctuation et de diacritiques.',
      detailedStory: 'Pendant treize années consécutives, ADIGBE Togbédji enseigna le script Gbekoun et utilisa ce système pour écrire de nombreux livres aux titres variés. Il établit deux groupes d’instruction : l’un à Dangbo, dans son village natal de Mondoto, l’autre à Cotonou. Le système fut présenté comme capable de transcrire fidèlement toutes les langues nationales du Bénin et, par extension, toutes les langues maternelles africaines. L’objectif déclaré fut de permettre l’éducation en langues maternelles pour reconquérir la souveraineté des nations africaines.',
    ...
    },
    {
      ...
      description: 'Après le décès d’ADIGBE Togbédji le 25 janvier 2007, les disciples maintinrent les deux groupes d’instruction. En 2013, un événement extraordinaire se produisit : un “apprenant peu ordinaire” apparut. Cet homme s’approcha, enleva sa chemise et demanda si les gens de Gbekoun pouvaient guérir les multiples lésions de son corps. Rapidement, il développa des capacités étonnantes et parvint à décoder des messages codés du concepteur sans l’avoir jamais côtoyé..',
      detailedStory: 'Cet homme mystérieux adopta le style vestimentaire de Togbédji et un régime alimentaire particulier. Les témoins déclarèrent : “Nul doute ; de façon spectaculaire, le successeur de Togbédji venait de naître.” Il se fit appeler HOUESSE AYIGBEDEKIN Vidéhouénou et développa un système éducatif pluridisciplinaire en un temps record, fondé sur l’usage du script Gbekoun. Il baptisa son système académique “Premier Centre d’Éveil du Continent Noir”. De 2013 à 2016, il établit une école de formation des formateurs, puis en 2016, lança le centre de formation académique qu’il dirigea magistralement pendant trois ans.',
    ...
    },
    {
      ...
      description: 'Le 9 mars 2019, HOUESSE AYIGBEDEKIN Vidéhouénou s’en alla à son tour, laissant une fois de plus les disciples “orphelins de maître”. Cependant, le groupe de “témoins oculaires” des événements liés au script continua la mission avec une conviction inébranlable. Ils déclarèrent : “Le monde a changé d’ombre ; et le monde nouveau en cours, celui de développement et de l’éveil du Continent Noir établit son soleil levant au Bénin pour s’étendre sur le reste du continent et sur le monde entier.”',
